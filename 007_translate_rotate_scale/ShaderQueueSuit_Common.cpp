...
{
    std::string vertStr= FileUtil::loadAssetStr("shaders/007_translate_rotate_scale.vert");
    std::string fragStr= FileUtil::loadAssetStr("shaders/007_translate_rotate_scale.frag");
