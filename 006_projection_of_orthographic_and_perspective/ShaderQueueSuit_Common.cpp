...
void ShaderQueueSuit_Common::create_shader(VkDevice &device) {
    std::string vertStr = FileUtil::loadAssetStr("shaders/006_projection_of_orthographic_and_perspective.vert");
    std::string fragStr = FileUtil::loadAssetStr("shaders/006_projection_of_orthographic_and_perspective.frag");
